...
namespace DarkCanvas.ProceduralTerrain
{
    ...
    public class EndlessTerrain : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            MaxViewDistance = _detailLevels[_detailLevels.Length - 1].VisibleDistanceThreshold;
        ...
        private void Update()
        {
            ViewerPosition = new Vector2(_viewer.position.x, _viewer.position.z) / _mapGenerator.UniformScale;
        ...
        private TerrainChunk BuildTerrainChunk(Vector2 coordinates)
        {
            return new TerrainChunk(
                new TerrainChunkParams
                {
                    ...
                    UniformScale = _mapGenerator.UniformScale,
