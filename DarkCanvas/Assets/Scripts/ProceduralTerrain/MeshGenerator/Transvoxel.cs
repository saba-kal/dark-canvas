namespace DarkCanvas.ProceduralTerrain
{
    ...
    public static class Transvoxel
    {
        ...
        public class TransitionCellData
        {
            ...
            public TransitionCellData(byte geometryCounts, byte[] vertexIndex)
            {
                this.geometryCounts = geometryCounts;
                this.vertexIndex = vertexIndex;
            }
        ...
        public static TransitionCellData[] transitionCellData = new TransitionCellData[]
        {
            new TransitionCellData(0x00, new byte[] {}),
        ...
        public static ushort[][] transitionVertexData = new ushort[][]
        {
            new ushort[] {},
